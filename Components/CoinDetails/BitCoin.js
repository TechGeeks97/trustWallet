            ...
            <ScrollView style={{ flex: 1 }}>
                <View style={{ height: 30, alignItems: 'center' }}>
                    <View style={{ height: '100%', width: '95%', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        <Text style={{ fontSize: 14 }}>$ 19,520.15 <Text style={{ fontSize: 13, color: 'green' }}>+5.35%</Text></Text>
                    </View>
                </View>
                ...
                <View style={{ height: 30, alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ fontSize: 17 }}>0 BTC</Text>
                </View>
                ...
                <View style={{ height: 30, justifyContent: 'center', alignItems: 'center' }}>
                    <Text style={{ color: Colors.secondary, fontSize: 15, fontWeight: '700' }}>Buy BTC</Text>
                </View>
            </ScrollView>
